...
function volver(){ jsInterfazNativa.volver(); }
function eventoInfo(){
    document.location.href= "https://us-central1-eventos-67df9.cloudfunctions.net/mostrarEventosHtml?evento="+info;
}
