...
public class FotografiasDrive extends AppCompatActivity {
    ...
    private final String idCarpetaCompartida = "1ZhGW28JUi4Ar6GqZBqTqEgBkulBm0M9f";
    private final String idCarpetaRetoEstoyAqui = "1ktWF2rMnWmzJjRljxCuRpI6Tm72f6Ro8";
