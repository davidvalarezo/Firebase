    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_twitter:
                ...
                mFirebaseAnalytics.logEvent("menus", bundle);
                Intent intentTW = new Intent(getBaseContext(), TwitterActivity.class);
            ...
            case R.id.action_facebook:
                ...
                mFirebaseAnalytics.logEvent("menus", bundle);
                Intent intentFB = new Intent(getBaseContext(), FacebookActivity.class);
                intentFB.putExtra("evento", evento);
                startActivity(intentFB);
                //publicarFotoConShareDialog(vista);
                break;
        }
